...
//        candidate.setVisibilitySettings("PUBLIC");
...
//                exp.setCurrent(dto.getDuration().getEnd() == null);
//            }
...
//                edu.setCurrent(dto.getDuration().getEnd() == null);
//            }
...
//        skills.setProgrammingLanguages(String.join(", ", skillsDto.getProgrammingLanguages()));
//        skills.setTechnicalSkills(String.join(", ", skillsDto.getTechnicalSkills()));
//        skills.setToolsAndTechnologies(String.join(", ", skillsDto.getToolsAndTechnologies()));
//        skills.setSoftSkills(String.join(", ", skillsDto.getSoftSkills()));
//        skills.setCustomSkills(String.join(", ", skillsDto.getCustomSkills()));
